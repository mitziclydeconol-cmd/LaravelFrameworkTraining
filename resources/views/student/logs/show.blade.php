    ...
    <div class="col-xl-9">
            ...
            <div class="d-flex align-items-start justify-content-between flex-wrap gap-3">
                <div>
                    ...
                    <div class="d-flex gap-3 text-muted flex-wrap" style="font-size:.82rem;">
                        ...
                        <span><i class="bi bi-pencil me-1"></i>Logged {{ $log->created_at->diffForHumans() }}</span>
                    </div>
                </div>
                    ...
                    @foreach($log->aiFeedbackLogs as $feedback)
                        <div class="border rounded-3 p-3 mb-3 {{ !$loop->last ? 'mb-3' : '' }}">
                            ...
                            @if($feedback->feedback_received)
                                <div class="ai-feedback-box" style="font-size:.82rem;max-height:300px;overflow-y:auto;">
                                    {!! nl2br(e($feedback->feedback_received)) !!}
                                </div>
                            @endif
                        </div>
                    @endforeach
        ...
        @else
            <div class="ct-card p-4 mb-4 text-center">
                ...
                <p class="text-muted mt-2 mb-2">No code snippet attached to this log.</p>
                <a href="{{ route('student.logs.edit', $log) }}" class="btn btn-sm btn-outline-primary">
                    Add Code Snippet
                </a>
            </div>
        @endif
